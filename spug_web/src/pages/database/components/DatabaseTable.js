...
const DatabaseTable = observer(() => {
  ...
  return (
    <TableCard
      ...
      actions={[
        <AuthButton type="primary" icon={<PlusOutlined/>} auth="database.instance.add" onClick={() => store.showForm()}>新建连接</AuthButton>
      ]}
